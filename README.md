...
Bedingte Funktionen: COUNTIF(S), SUMIF(S), AVERAGEIF(S) zur Analyse nach Ländern, Kunden oder Bedingungen

Textfunktionen: CONCATENATE, TEXTJOIN, LEFT, RIGHT, EXACT zur Bereinigung und Vergleich von Textdaten
...
Unterschiede im Kaufverhalten zwischen Kunden
...
Gesamtdauer des Bestellzeitraums

Entwicklung der Bestellhäufigkeit
...
Sortierung der Daten nach InvoiceDate

Berechnung des Umsatzes pro Datensatz

Filterung des jeweils höchsten Umsatzes pro Tag
...
Excel-Kenntnisse praxisnah anzuwenden

Einen vollständigen Datenanalyse-Workflow umzusetzen

Geschäftliche Erkenntnisse aus realen Online-Retail-Daten zu gewinnen
